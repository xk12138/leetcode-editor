...
public class PersistentConfig implements PersistentStateComponent<PersistentConfig> {
    ...
    public static final String ROOT_DIR = "leetcode/";
    public static String PATH = ROOT_DIR + "editor";
    ...
    public String getAbsoluteFilePath() {
        return PATH + File.separator + initConfig.get(INITNAME).getAlias() + File.separator;
    }
